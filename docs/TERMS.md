...
These terms apply to the free `ramageddon-game` Reddit interactive app. By
playing, you agree to these terms, Reddit's User Agreement and Content Policy,
and the rules of the subreddit hosting the game.
...
Do not manipulate requests, automate submissions, exploit defects, impersonate
another player, interfere with the service, or submit fabricated scores. The
app may reject, rate-limit, or remove implausible or abusive game records to
protect the shared competition.
...
The app is provided on an "as is" and "as available" basis. Runs or scores may
fail to save because of connectivity, platform maintenance, moderation,
technical faults, or abuse prevention. To the extent permitted by law, the
creators disclaim implied warranties and are not liable for indirect,
incidental, special, or consequential loss arising from use of the app.

Nothing in these terms excludes a right or remedy that cannot legally be
